...
namespace Unity.AI.Assistant.UI.Editor.Scripts.Components
{
    ...
    partial class AssistantSkillsSettingsView : ManagedTemplate
    {
        ...
        void RefreshSkillsList()
        {
            ...
            var allSkills = SkillsRegistry.GetSkills();
            ...
            BuildIssuesFoldouts(errors, filter);
        }
        ...
        private void BuildSkillsFoldouts(List<KeyValuePair<string, SkillDefinition>> skills, string filter)
        {
            ...
            {
                var enableButton = new Button(SkillsScanner.CreateUserFolder) { text = "Enable custom skills" };
                enableButton.AddToClassList("assistant-skills-enable-button");
                m_UserSkillsContainer.Add(enableButton);
            }
        ...
        void BuildIssuesFoldouts(IReadOnlyList<SkillFileIssue> issues, string filter)
        {
            var anySkills = issues.Count > 0 || m_MinorIssues.Count > 0;
