...
namespace Unity.AI.Assistant.UI.Editor.Scripts.Components.WhatsNew
{
    ...
    {
        internal const string k_LearnMoreUrl = "https://discussions.unity.com/t/release-notes-april-14-2026/1716515";
        ...
        static readonly string[] k_Bullets =
        {
            ...
            "GetConsoleLogs tool timestamps added.",
            "MCP Server settings subtitle text overflow fixed.",
            "The overarching Preferences search bar in Settings now finds matches on the Assistant tab.",
            "Tool renderer header icons were getting squashed when the tool call title was too long."
        };
