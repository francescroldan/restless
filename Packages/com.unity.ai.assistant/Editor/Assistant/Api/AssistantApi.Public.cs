...
namespace Unity.AI.Assistant.Editor.Api
{
    static partial class AssistantApi
    {
        ...
        internal static async Task Run(string userPrompt, AttachedContext attachedContext = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken">A cancellation token that can be used to cancel the asynchronous operation.</param>
        /// <returns>A task</returns>
        internal static async Task PromptThenRun(Rect parentRect, string placeholderPrompt = "", AttachedContext attachedContext = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken">A cancellation token that can be used to cancel the asynchronous operation.</param>
        /// <returns>A task</returns>
        internal static async Task PromptThenRun(VisualElement parent, string placeholderPrompt = "", AttachedContext attachedContext = null, CancellationToken cancellationToken = default)
        {
        ...
        internal static async Task<string> RunHeadless(this IAgent agent, string userPrompt, AttachedContext attachedContext = null, CancellationToken cancellationToken = default)
        {
